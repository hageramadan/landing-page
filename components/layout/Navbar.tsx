...
const Navbar = () => {
  ...
  const handleLinkClick = (e: React.MouseEvent<HTMLAnchorElement>, linkKey: string, href: string) => {
                  ...
                  <Link
                    ...
                    className={`transition-colors font-medium text-sm xl:text-base whitespace-nowrap pb-1 ${
                      activeLink === link.key
                        ...
                        : "text-[#2b2974e3] hover:text-[#4584C5]"
                    }`}
                  >
...
<div className="order-3 hidden lg:flex items-center gap-4">
  <motion.button
    ...
    className="text-white px-4 py-1.5 md:px-5 md:py-2 rounded-lg text-sm xl:text-base whitespace-nowrap flex items-center gap-2 group cursor-pointer"
    style={{
                ...
                <Link
                  ...
                  className={`transition py-3 px-4 text-center text-base font-medium ${
                    activeLink === link.key
                      ...
                      : "text-[#2b2974e3] hover:text-[#4584C5] hover:bg-gray-50"
